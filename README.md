...
| [Iris Species]([https://github.com/slowladin/portfolio/tree/main/1.ChocolateSalesData_EDA](https://github.com/slowladin/portfolio/tree/main/2.Iris_species)) |EDA, K-Means, Random Forest |Goal: Perform EDA on the Iris dataset, compare the predictive capabilities of k-means and Random Forest.| *Pandas, sklearn, Python, matplotlib, seaborn* |
